...
use App\Http\Controllers\Student\GradeCurricularController;
...
Route::group(['as' => 'student.'], function () {
    //Grade curricular
    Route::get('grade', [GradeCurricularController::class, 'mostrarGrade'])->name('grade');
    
    //Start:: My Learning Course
    Route::post('aceitacontrato', [MyCourseController::class, 'aceitacontrato'])->name('aceitacontrato');
    Route::get('aceite-contrato', [MyCourseController::class, 'primeiroLogin'])->name('aceite-contrato');
