                            ...
                            <div class="certificate-check-form">
                                <div class="form-vertical__item bg-style">
                                    <div class="item-top mb-3">
                                        ...
                                        <p class="pt-3">Para validar certificados, insira o ID do certificado neste campo de entrada e clique no botão Validar.</p>
                                    </div>
                                    <form id="certificate-form">
                                        ...
                                        <div class="input__group mb-25">
                                            <button type="submit" id="check-certificate" class="theme-btn default-hover-btn theme-button1">Validar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
