                        ...
                        <div class="item-title d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{route('consultation-report.revenue-report')}}" class="btn btn-success btn-sm">
                                    {{ __('Relatório de consulta de receita') }} <span class="iconify" data-icon="akar-icons:arrow-right"></span>
                                </a>
                            </div>
                        </div>
                        <div class="mb-5">
                            <caption><b>Nota:</b>Se algum instrutor cancelar sua consulta de reserva. O administrador precisa devolver o dinheiro manualmente. Depois de devolver o dinheiro manualmente, o administrador pode
                                enviar mudança de status de dinheiro <b>Não</b> para <b>Sim</b></caption>
                        </div>
