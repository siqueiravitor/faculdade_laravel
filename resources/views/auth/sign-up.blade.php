                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                ...
                                <input type="email" name="email" id="email" value="{{old('email')}}"
                                    class="form-control" placeholder="Informe seu melhor e-mail">
                                @if ($errors->has('email'))
                                ...
                                <div>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label mb-0" for="flexCheckChecked">
                                            Ao clicar em cadastra-se, concordo que li e aceito os
                                            <a href="{{ route('terms-conditions') }}"
                                                class="color-hover text-decoration-underline">Termos de uso</a> e 
                                                <a href="{{ route('privacy-policy') }}"
                                                class="color-hover text-decoration-underline">política de privacidade</a>
                                        </label>
                                    </div>
                                </div>
                            </div>
