...
<section class="sign-up-page p-0">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-md-5">
                <div class="sign-up-left-content" style='background: #0b3738!important'>
            ...
            <div class="col-md-7">
                <div class="sign-up-right-content bg-white">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- <div class="row mb-30">
                                <div class="col-md-12">
                                    <label class="label-text-title color-heading font-medium font-16 mb-3">{{__('Email ou Telefone')}}</label>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Matrícula, CPF ou Email') }}</label>
                                <input type="text" name="cpf_matricula_email" value="{{ old('cpf_matricula_email') }}" class="form-control" placeholder="{{ __('Digite sua Matrícula, CPF ou Email ') }}">
                                @if ($errors->has('cpf_matricula_email'))
                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('cpf_matricula_email') }}</span>
                                @endif
                            </div>
                        </div>
