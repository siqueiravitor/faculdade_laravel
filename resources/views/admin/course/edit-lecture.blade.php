                        ...
                        <div id="msform">
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div class="upload-course-step-item upload-course-video-step-item">
                                    <form method="POST" action="{{route('admin.update.lecture', [$lecture->uuid])}}" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="row mb-30">
                                                    <div class="col-md-12">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class='d-flex flex-wrap justify-content-around w-100' style='gap:1rem'>
...
{{--                                                    <textarea name="text_description" id="open-source-plugins">{{ $lecture->text }}</textarea>--}}
                                                ...
                                                <div class="main-upload-video-processing-box mt-3">
