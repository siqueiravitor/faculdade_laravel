                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div class="upload-course-step-item upload-course-video-step-item">
                                    ...
                                    @if($course->lessons->count() > 0)
                                        ...
                                        <div id="upload-course-video-2">
                                            <div class="upload-course-item-block course-overview-step1 radius-8">
                                                <div class="upload-course-item-block-title mb-3">
                                                    <p class="color-para">Lista de grupos <span class="color-heading">“{{$course->title}}”</span></p>
                                                </div>
                                                                    ...
                                                                    <div class="accordion-header mb-0" id="headingOne">
                                                                        <button
                                                                            ...
                                                                            <span class="d-flex upload-course-video-6-duration-count">
                                                                                <span class="upload-course-duration-text font-14 color-para font-medium">
                                                                                    <span class="iconify" data-icon="octicon:device-desktop-24"></span>
                                                                                    {{ __('Video') }}
                                                                                    <span class="color-heading">({{$lesson->lectures->count()}})</span>
                                                                                </span>
                                                                                <span class="upload-course-duration-text font-14 color-para font-medium">
                                                                                    <span class="iconify" data-icon="ant-design:clock-circle-outlined"></span>
                                                                                    {{ __('Duration') }} 
                                                                                    <span class="color-heading">({{@$lesson->lectures->count() > 0 ? lessonVideoDuration($course->id, $lesson->id) : '0 min'}})</span>
                                                                                </span>
                                                                            </span>
                                                                        </button>
                                                                    </div>
                                                                    <div id="collapse{{$key}}" class="accordion-collapse collapse {{$key == 0 ? 'show' : '' }} "
                                                                        ...
                                                                        <div class="accordion-body">
                                                                            @forelse($lesson->lectures as $lecture)
                                                                                <div class="main-upload-video-processing-item removable-item mb-3 pb-3 border-bottom">
                                                                                    ...
                                                                                    <div class="d-flex">
                                                                                        <div class="flex-shrink-0">
                                                                                            <div
                                                                                                ...
                                                                                                <a href="{{route('admin.edit.lecture', [$course->uuid, $lesson->uuid, $lecture->uuid])}}"
                                                                                                   type="button"
                                                                                                ...
                                                                                                <a href="javascript:void(0);"
                                                                                                   data-url="{{route('admin.delete.lecture', [$course->uuid,  $lecture->uuid])}}"
                                                                                ...
                                                                                <div class="d-flex justify-content-between align-items-center">
                                                                                    ...
                                                                                    <div>
                                                                                        <button type="button" data-name="{{ $lesson->name }}"
                                                                                                data-route="{{ route('admin.lesson.update', [$course->uuid, $lesson->uuid]) }}"
                                                                                        ...
                                                                                        <form action="{{ route('admin.lesson.delete', [$lesson->uuid]) }}" method="post"
                                                                            ...
                                                                            {{-- <div class="mt-3 lecture-edit-upload-btn">
                                                                                <a href="{{route('admin.upload.lecture', [$course->uuid, $lesson->uuid])}}"
                                                ...
                                                @else
                                                    @foreach($course->lessons as $lesson)
                                                        <div class="upload-video-introduction-box-wrap" style='margin-bottom: 1rem'>

                                                            <!-- upload-video-introduction-box -->
                                                            <div class="upload-video-introduction-box border">

                                                                <div class="upload-introduction-title-box d-flex align-items-center justify-content-between p-3 border"
                                                                style='background-color: rgba(196, 196, 196, 0.12);'>
                                                                    <h6 class="font-16">{{$lesson->name}}</h6>
                                                                    <div class="d-flex upload-course-video-6-duration-count" style='gap:1rem'>
                                                                        <div class="upload-course-duration-text font-14 text-dark font-medium">
                                                                ...
                                                                <div class="upload-introduction-box-content d-flex align-items-center justify-content-between" style='margin: 20px'>
                                                                    <div class="upload-introduction-box-content-left d-flex align-items-center">
                                                                        ...
                                                                        <a href="{{route('admin.upload.lecture', [$course->uuid, $lesson->uuid])}}"
                                                                           class="common-upload-lesson-btn btn btn-outline-dark btn-sm font-13 font-medium" style='margin-left: 1rem; padding: 7px 16px'>
                                                                           <span class="iconify" data-icon="feather:upload-cloud" style='margin-right: .5rem'></span>{{ __('Upload lesson') }}</a>
                                                                    </div>
                                                                    <div class="d-flex" style='gap:1rem'>
                                                                        <!-- <button type="button" data-name="{{ $lesson->name }}"
                                                                                data-route="{{ route('admin.lesson.update', [$course->uuid, $lesson->uuid]) }}"
                                                                                class="upload-course-video-edit-btn font-14 text-dark font-medium bg-transparent border-0 editLesson"
                                                                                data-bs-toggle="modal" data-bs-target="#becomeAnInstructor">
                                                                            <span class="iconify" data-icon="clarity:note-edit-line"></span>{{ __('Edit') }}</button> -->
                                                                        <button
                                                                            class="upload-course-video-edit-btn font-14 text-dark font-medium bg-transparent border-0 deleteItem"
                                                                            data-formid="delete_row_form_{{$lesson->uuid}}">
                                            ...
                                            <div class="add-more-section-wrap d-none" style='margin-top: 2rem'>
                                                <form method="POST" action="{{route('admin.lesson.store', [$course->uuid])}}" class="row g-3 needs-validation" novalidate>
                                                    @csrf
                                                    <div class="row mb-10">
                                                        <div class="col-md-12">
                                                            <label class="label-text-title color-heading font-medium font-16 mb-3">Título do grupo do curso “ {{$course->title}}
                                                                ”</label>
                                                            <input type="text" name="name" value="{{old('name')}}" required class="form-control" placeholder="Nome do grupo">
                                                            @if ($errors->has('name'))
                                            ...
                                            <div class="stepper-action-btns d-flex justify-content-between align-items-center add-more-lesson-box">
                                                <!-- <div>
                                                    <a href="{{route('admin.course.edit', [$course->uuid, 'step=category'])}}"
                                                       class="theme-btn theme-button3">{{__('Back')}}</a>
                                                    @if($course->lectures->count() > 0)
                                                        <a href="{{route('admin.course.edit', [$course->uuid, 'step=instructors'])}}" type="button"
                                                           class="theme-btn theme-button1">{{__('Save and continue')}}</a>
                                                    @endif
                                                </div> -->

                                                <!-- When click this button show: "add-more-section-wrap" -->
                                                <a href="javascript:void (0);" type="button" class="add-more-section-btn font-14 color-heading font-medium btn">
                                        ...
                                        <!-- <input type="button" name="previous" class="previous action-button-previous action-button theme-btn theme-button3" value="Back"/> 
                                        <input type="button" name="next" class="next action-button default-hover-btn theme-btn theme-button1" value="Save & continue"/> -->
                                        <form class="row mb-3" method='GET' action="{{route('admin.course.index')}}"> 
                                                    ...
                                                    <div class="row mb-30">
                                                        <div class="col-md-12">
                                                            <label class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Section title of the coures') }} “ {{$course->title}}
                                                                ”</label>
                                                            <input type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="Introduction" required autocomplete='off'>
                                                            @if ($errors->has('name'))
                                                                <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('name') }}</span>
                                                            @endif
                                                        </div>
