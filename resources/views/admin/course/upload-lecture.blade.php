                    ...
                    <div id="msform">
                        ...
                        <div class="upload-course-step-item upload-course-overview-step-item">
                            ...
                            <div class="upload-course-step-item upload-course-video-step-item">
                                <form method="POST" action="{{route('admin.store.lecture', [$course->uuid, $lesson->uuid])}}"
                                    ...
                                    <div id="upload-course-video-4">
                                        <div class="upload-course-item-block course-overview-step1 radius-8">
                                            ...
                                            <div id="youtube" class="d-none mb-4">
                                            ...
                                            <div id="vimeo" class="d-none mb-4">
                                                <div class="row mb-30">
                                                    <div class="col-md-12">
                                                        <label
                                                            class="label-text-title color-heading font-medium font-16 mb-3">{{
                                            ...
                                            <div id="pdfDiv" class="d-none mb-4">
                                                <label
                                                    class="label-text-title color-heading font-medium font-16 mb-3">{{
                                            ...
                                            <div id="slide_documentDiv" class="d-none mb-4">
                                                <label
                                                    class="label-text-title color-heading font-medium font-16 mb-3">{{
                                            ...
                                            <div id="audioDiv" class="d-none mb-4">
                                                <label
                                                    class="label-text-title color-heading font-medium font-16 mb-3">{{
