        ...
        <div class="row">
            <div class="col-md-12">
                <div class="customers__area bg-style mb-30">
                    ...
                    <form action="{{route('student.update', $student->uuid)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="email" name="email" value="{{ @$student->user->email }}" placeholder="Email" class="form-control" required>
                                    @if ($errors->has('email'))
                                    <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="phone_number" value="{{ $student->phone_number }}" placeholder="Phone number" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="address" value="{{ $student->address }}" placeholder="Address" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="postal_code" value="{{ $student->postal_code }}" placeholder="Postal Code" class="form-control" required>
