                ...
                <div class="col-lg-4 col-md-5">
                    <div class="profile__item bg-style">
                        ...
                        <ul class="profile__item__list">
                            ...
                            <li>
                                <div class="list-item">
                                    <h2>{{__('Aniversário')}}:</h2>
                                    <p>{{$student->data_nascimento}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="list-item">
                                    <h2>{{__('Estado civil')}}:</h2>
                                    <p>{{$student->estado_civil}}</p>
                                </div>
                            </li> 
                            <li>
                                <div class="list-item">
                                    <h2>{{__('Naturalidade')}}:</h2>
                                    <p>{{$student->naturalidade}}</p>
                                </div>
                            </li>
                            <li>
                                <div class="list-item">
                                    <h2>{{__('Título de eleitor')}}:</h2>
                                    <p>{{ $user['titulo'] }}</p>
                                </div>
                            </li>
                            <li>
