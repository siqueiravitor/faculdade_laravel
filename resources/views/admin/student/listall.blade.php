                    ...
                    <div class="breadcrumb__content__right">
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{('Todos Usuários') }}</li>
                            </ul>
                        </nav>
                    </div>
                </div>
                                ...
                                <tr class="removable-item">
                                    ...
                                    <td>
                                        <div class="action__buttons">
                                            ...
                                            <!-- Restante do código para quando o UUID existe -->
                                            @else
                                            <!-- Código para quando o UUID não existe -->
                                            <span class="btn-action-disabled mr-30" title="View Details" disabled>
                                              
                                            </span>
                                            <!-- Restante do código para quando o UUID não existe -->
                                            @endif
                                            @if ($student->uuid)
