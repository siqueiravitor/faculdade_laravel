                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('Matrícula')}} <span class="text-danger">*</span></label>
                                    <input type="text" disabled name="matricula" value="{{ $matricula }}" placeholder="{{ __('Matrícula') }}" class="form-control" readonly>
                                    @if ($errors->has('Matrícula'))
                                    <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{ $errors->first('Matrícula') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <select name="organization_id" id="organization_id" class="form-select">
                                        <option value="">{{__('Polo')}}</option>
                                        @foreach($organizations as $organization)
                                        <option value="{{$organization->id}}" @if(old('organization_id')) {{old('organization_id') == $organization->id ? 'selected' : '' }} @endif>{{$organization->first_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('Estado Civil')}} <span class="text-danger">*</span></label>
                                    <select name="estado_civil" id="estado_civil" class="form-select">
                                        ...
                                        <option selected value="Solteiro" {{old('estado_civil') == 'Solteiro' ? 'selected' : '' }}>{{ __('Solteiro(a)') }}</option>
                                        <option value="Divorciado" {{old('estado_civil') == 'Divorciado' ? 'selected' : '' }}>{{ __('Divorciado(a)') }}</option>
                                        <option value="Viúvo" {{old('estado_civil') == 'Viúvo' ? 'selected' : '' }}>{{ __('Viúvo(a)') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('Cpf')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="cpf" value="{{old('cpf')}}" placeholder="{{ __('Cpf') }}" class="form-control" required>
                                    @if ($errors->has('cpf'))
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('RG')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="rg" value="{{old('rg')}}" placeholder="{{ __('RG') }}" class="form-control" required>
                                    @if ($errors->has('rg'))
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('Data de nascimento')}} <span class="text-danger">*</span></label>
                                    <input type="date" name="data_nascimento" value="{{old('data_nascimento')}}" placeholder="{{ __('Data de nascimento') }}" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('Filiação')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="filiacao" value="{{old('filiacao')}}" placeholder="{{ __('Filiação') }}" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('Naturalidade')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="naturalidade" value="{{old('naturalidade')}}" placeholder="{{ __('Naturalidade') }}" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{__('Título de eleitor')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="titulo_eleitor" value="{{old('titulo_eleitor')}}" placeholder="{{ __('Título de eleitor') }}" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="address" value="{{old('address')}}" placeholder="{{ __('Address') }}" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <select name="country_id" id="country_id" class="form-select">
                                        ...
                                        @foreach($countries as $country)
                                        <option value="{{$country->id}}" @if(old('country_id')) {{old('country_id') == $country->id ? 'selected' : '' }} @endif>{{$country->country_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="input__group mb-25">
                                    <label>{{ __('About Student') }} </label>
                                    <textarea name="about_me" id="" cols="15" rows="5">{{ old('about_me') }}</textarea>
