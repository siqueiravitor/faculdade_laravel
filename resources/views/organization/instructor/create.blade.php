                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <input type="text" name="professional_title" value="{{ old('professional_title') }}"
                            placeholder="{{ __('Professional Title') }}" class="form-control" >
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <input type="text" name="postal_code" value="{{ old('postal_code') }}"
                            placeholder="{{ __('Postal Code') }}" class="form-control" >
                    ...
                    <div class="col-md-12">
                        <label class="font-medium font-15 color-heading">{{ __('About Instructor') }} </label>
