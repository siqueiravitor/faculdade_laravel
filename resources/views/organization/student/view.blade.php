                    ...
                    <div class="organization-student-profile">
                        <div class="organization-stu-top d-flex align-items-center">
                            <div class="flex-shrink-0 customer-review-item-img-wrap radius-50 overflow-hidden">
                                <img src="{{ asset($student->user ? $student->user->image_path : '') }}" alt="user" class="radius-50 fit-image">
                            </div>
                    ...
                    <div class="organization-stu-personal-info-tbl mt-3">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td>{{ __('Naturalidade') }}:</td>
                                    <td>{{ $student->naturalidade }}</td>
                                </tr>
                                <tr>
                                    <td>{{ __('Título de eleitor') }}:</td>
                                    <td>{{ $user['titulo'] }}</td>
                                </tr>
                                <tr>
                                    <td>{{ __('Address') }}:</td>
                                ...
                                <tr>
                                    <td>{{ __('Location') }}:</td>
                                    <td>{{ $student->city ? $student->city->name.', ' : '' }}{{ $student->state ? $student->state->name.', ' : '' }}{{ $student->country ? $student->country->country_name : '' }}</td>
                                </tr>
                                <tr>
                                    <td>{{ __('Criador') }}:</td>
                                    <td>{{ $user['criador'] }}</td>
                                ...
                                <tr>
                                    <td>
                                        <a target="_blank" href="{{ route('course-details', [@$enrollment->course->slug]) }}">
                                            <img src="{{ getImageFile(@$enrollment->course->image_path) }}" class="img-fluid" width="80"></a>
                                    </td>
