...
<div class="instructor-profile-right-part">
    <form method="POST" action="{{ route('organization.student.store') }}" enctype="multipart/form-data" autocomplete="off">
        @csrf
        <div class="instructor-profile-info-box">
            ...
            <div class="row">
                <div class="col-md-6 mb-30">
                    ...
                    <input type="text" name="matricula" disabled value="{{ $matricula }}" placeholder="{{ __('Matrícula') }}" class="form-control" readonly>
                ...
                <div class="col-md-6 mb-30">
                    <label class="font-medium font-15 color-heading">{{ __('Password') }} <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6 mb-30">
                    ...
                    <input type="text" name="phone_number" value="{{ old('phone_number') }}" placeholder="{{ __('Phone Number') }}" class="form-control">
                ...
                <div class="col-md-6 mb-30">
                    ...
                    <select name="country_id" id="country_id" class="form-select">
                        ...
                        <option value="{{ $country->id }}" @if (old('country_id')) {{ old('country_id') == $country->id ? 'selected' : '' }} @endif>
                ...
                <div class="col-md-12">
                    <label class="font-medium font-15 color-heading">{{ __('About Student') }} </label>
                    <textarea name="about_me" id="" cols="15" rows="5" class="form-control">{{ old('about_me') }}</textarea>
