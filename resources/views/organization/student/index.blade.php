                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('organization.student.edit', $student->uuid) }}" class=""><img src="{{ asset('admin/images/icons/edit-2.svg') }}" alt="eye"></a>
                                    <a href="{{ route('organization.student.view', $student->uuid) }}" class="ms-2"><img src="{{ asset('admin/images/icons/eye-2.svg') }}" alt="eye"></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
