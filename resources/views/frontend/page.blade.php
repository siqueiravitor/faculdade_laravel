...
@section('meta')
    ...
    <meta name="title" content="Fama Educacional">
    <meta name="description" content="Fama Educacional">
    ...
    <meta property="og:title" content="Fama Educacional">
    <meta property="og:description" content="Fama Educacional">
    ...
    <meta name="twitter:title" content="Fama Educacional">
    <meta name="twitter:description" content="Fama Educacional">
    <meta name="twitter:image" content="{{ getImageFile(@$page->og_image) }}">
@endsection
@section('scripts')
    <script>
        var newDescription = "Fama Educacional";
