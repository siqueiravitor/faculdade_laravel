...
<section class="menu-section-area @auth isLoginMenu @endauth">
    ...
    <nav class="navbar sticky-header navbar-expand-lg" id="mainNav">
        <div class="container-fluid">
            ...
            (($authUser->role == USER_ROLE_STUDENT && auth::user()->student->primeiro_login == 2) ||
            ($authUser->role == USER_ROLE_ORGANIZATION || $authUser->role == USER_ROLE_INSTRUCTOR)))
                ...
                <div class="header-nav-left-side me-auto d-flex">
                    ...
                    <form action="#">
                        <div class="input-group landing">
                            ...
                            <input class="form-control me-2 searchCourse" id="searchCourse" type="search" name="keyword" value="{{request('keyword')}}" placeholder="{{__('Search Course')}}..." aria-label="Search">
                        </div>
                ...
                <div class="header-nav-right-side d-flex">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown menu-round-btn menu-user-btn dropdown-top-space">
                            ...
                            <div class="dropdown-menu-profile dropdown-menu {{$selectedLanguage->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end'}}" data-bs-popper="none">
                                ...
                                <ul class="user-dropdown-item-box">
                                    <li><a class="dropdown-item" href="{{ route('student.my-learning') }}"><span class="iconify" data-icon="akar-icons:book"></span>{{__('My Learning')}}
                                        </a></li>
...
<!--                                    <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('student.grade') }}">
                                            <span class="iconify mr-15" data-icon="carbon:grid"></span> {{
                                            __('Grade') }} 
                                        </a>
                                    </li>
                                    @endif
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('subscription_panel') }}"><span class="iconify" data-icon="akar-icons:desktop-device"></span>
                                            {{ __('Subscription Panel') }}</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('student.subscription_plan') }}"><span class="iconify" data-icon="eos-icons:subscriptions-created"></span>
                                ...
                                <ul class="user-dropdown-item-box">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('student.all_login_device') }}"><span class="iconify" data-icon="akar-icons:desktop-device"></span>
                                            {{ __('Device Control') }}</a>
                                    </li>
                                    @endif
                                ...
                                <ul class="user-dropdown-item-box">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.dashboard') }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--bxs" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="bxs:dashboard">
                                ...
                                <ul class="user-dropdown-item-box">
                            <!-- /support-ticket-faq                                
                                    <li><a class="dropdown-item" href="{{ route('support-ticket-faq') }}"><span class="iconify" data-icon="bx:bx-help-circle"></span>{{__('Help
                                            Support')}}
                                        </a></li>
                                </ul>-->
