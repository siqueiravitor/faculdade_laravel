                ...
                <div class="table-responsive table-responsive-xl">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if(isset($matriculas[$enrollment->user->id]))
                                    {{ $matriculas[$enrollment->user->id]->codigo_matricula }}
                                    @else
                                    <!-- Lida com o caso em que não há matrícula associada ao usuário -->
                                    Sem matrícula
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="red-blue-action-btns">
                                        <button type="button" data-country="{{@$enrollment->user->student->country->country_name}}" data-image="{{ getImageFile($enrollment->user->image) }}" data-item="{{ $enrollment }}" data-purchase_date="{{ @$enrollment->start_date }}" data-bs-toggle="modal" data-bs-target="#allStudentViewModal" class="theme-btn theme-button1 green-theme-btn default-hover-btn viewStudent">{{ __('View') }}</button>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="student-detail-info-row">
                                <div class="all-student-modal-inner row">
                                    <div class="all-student-info-title col-sm-6 col-md-6 col-lg-4">{{ __('Course Name') }} <span>:</span></div>
                                    <div class="all-student-info-value col-sm-6 col-md-6 col-lg-8 course_name"></div>
                                </div>
                                <div class="all-student-modal-inner row">
                                    <div class="all-student-info-title col-sm-6 col-md-6 col-lg-4">{{ __('Course Join Date') }} <span>:</span></div>
                                    <div class="all-student-info-value col-sm-6 col-md-6 col-lg-8 purchase_date"></div>
                                </div>
                                <div class="all-student-modal-inner row">
                                    <div class="all-student-info-title col-sm-6 col-md-6 col-lg-4">{{ __('Email') }} <span>:</span></div>
                                    <div class="all-student-info-value col-sm-6 col-md-6 col-lg-8 email"></div>
                                </div>
                                <div class="all-student-modal-inner row">
                                    <div class="all-student-info-title col-sm-6 col-md-6 col-lg-4">{{ __('Phone') }} <span>:</span></div>
                                    <div class="all-student-info-value col-sm-6 col-md-6 col-lg-8 phone"></div>
                                </div>

                                <div class="all-student-modal-inner row">
                                    <div class="all-student-info-title col-sm-6 col-md-6 col-lg-4">{{ __('Country') }} <span>:</span></div>
                                    <div class="all-student-info-value col-sm-6 col-md-6 col-lg-8 country"></div>
                                </div>
                            </div>
                        </div>
                    </div>
