                                    ...
                                    <div class="course-item-bottom">
                                        ...
                                        <div class="instructor-my-courses-btns d-inline-flex">
                                             @if (is_null($course->organization_id))
                                                <a href="{{route('instructor.course.edit', [$course->uuid, 'step=lesson'])}}" class="para-color font-14 font-medium d-flex align-items-center"><span class="iconify" data-icon="bx:bx-edit"></span>{{ __('Edit') }}</a>
