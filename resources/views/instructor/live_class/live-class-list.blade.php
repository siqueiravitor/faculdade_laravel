            ...
            <div class="col-12">
                <ul class="nav nav-tabs assignment-nav-tabs live-class-list-nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link {{ @$navUpcomingActive }}" id="upcoming-tab" data-bs-toggle="tab" data-bs-target="#upcoming" type="button" role="tab" aria-controls="upcoming" aria-selected="true">{{ __('Upcoming') }}
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link {{ @$navCurrentActive }}" id="current-tab" data-bs-toggle="tab" data-bs-target="#current" type="button" role="tab" aria-controls="current" aria-selected="false">{{ __('Current') }}
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link {{ @$navPastActive }}" id="past-tab" data-bs-toggle="tab" data-bs-target="#past" type="button" role="tab" aria-controls="past" aria-selected="false">{{ __('Past') }}
                        </button>
                    </li>
                </ul>
                ...
                <div class="tab-content live-class-list" id="myTabContent">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="javascript:void(0);" data-url="{{ route('live-class.delete', $upcoming_live_class->uuid) }}" class="theme-btn default-delete-btn-red delete"><span class="iconify" data-icon="gg:trash"></span>{{ __('Delete') }}</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div class="tab-pane fade {{ @$tabCurrentActive }}" id="current" role="tabpanel" aria-labelledby="current-tab">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            Zoom
                                            <button class="theme-btn theme-button1 green-theme-btn default-hover-btn viewMeetingLink" data-item="{{ $current_live_class }}">
                                                {{ __('View') }}
                                            </button>
                                            @elseif($current_live_class->meeting_host_name == 'bbb')
                                            BigBlueButton
                                            <button class="theme-btn theme-button1 green-theme-btn default-hover-btn viewBBBMeetingLink" data-item="{{ $current_live_class }}" data-route="{{ route('instructor.join-bbb-meeting', $current_live_class->id) }}">
                                                {{ __('View') }}
                                            </button>
                                            @elseif($current_live_class->meeting_host_name == 'jitsi')
                                            Jitsi
                                            <button class="theme-btn theme-button1 green-theme-btn default-hover-btn viewJitsiMeetingLink" data-item="{{ $current_live_class }}" data-route="{{ route('join-jitsi-meeting', $current_live_class->uuid) }}">
                                                {{ __('View') }}
                                            </button>
                                            @elseif($current_live_class->meeting_host_name == 'gmeet')
                                            Gmeet
                                            <button class="theme-btn theme-button1 green-theme-btn default-hover-btn viewGmeetMeetingLink" data-url="{{ $current_live_class->join_url }}">
                                                {{ __('View') }}
                                            </button>
                                        ...
                                        <td><a href="javascript:void(0);" data-url="{{ route('live-class.delete', $current_live_class->uuid) }}" class="theme-btn default-delete-btn-red delete">
                    ...
                    <div class="tab-pane fade {{ @$tabPastActive }}" id="past" role="tabpanel" aria-labelledby="past-tab">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                            $id = Str::afterLast($past_live_class->join_url, '/');
                                            @endphp
                                            <a href="https://drive.google.com/drive/u/0/search?q={{ $id }}" class="theme-btn theme-button2 default-hover-btn">
                                                <span class="iconify" data-icon="gg:search"></span>{{ __('Localizar') }}
                                            </a>
                                        </td>
                                        <td>
                                            <!-- <a href="#" class="theme-btn theme-button1 default-hover-btn" data-toggle="modal" data-target="#videoModal">
                                                <span class="iconify" data-icon="gg:software-upload"></span>{{ __('Disponibilizar') }}
                                            </a> -->
                                            <button class="theme-btn theme-button1 green-theme-btn default-hover-btn viewGmeetMeetingLink" data-url="{{ $current_live_class->join_url }}">
                                                {{ __('View') }}
                                            </button>
                                        </td>
                                        <td><a href="javascript:void(0);" data-url="{{ route('live-class.delete', $past_live_class->uuid) }}" class="theme-btn default-delete-btn-red delete">
                                                <span class="iconify" data-icon="gg:trash"></span>{{ __('Delete') }}</a>
                                        </td>
                                    </tr>
                                    @endforeach
                ...
                <a href="{{ route('live-class.course-live-class.index') }}" class="theme-btn theme-button3 quiz-back-btn default-hover-btn">{{ __('Back') }}</a>
                <a href="{{ route('live-class.create', $course->uuid) }}" class="add-resources-btn theme-btn theme-button1 default-hover-btn">{{ __('Add Live Class') }}</a>
...
<div class="modal fade viewMeetingLinkModal" id="viewMeetingModal2" tabindex="-1" aria-labelledby="viewMeetingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="viewMeetingModalLabel2">{{ __('View Meeting') }}</h6>
        ...
        $('#save_video_url').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    // Atualize a página ou faça qualquer outra coisa após salvar a URL do vídeo
                    location.reload();
                },
