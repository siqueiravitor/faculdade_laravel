...
class NoticeBoardController extends Controller
{
    ...
    public function courseNoticeIndex()
    {
        ...
        $data['coursesId'] = CourseInstructor::select('course_id')->where('instructor_id', Auth::user()->id)->get();
        $data['courses'] = Course::whereIn('id', $data['coursesId'])->where('status', ACCESS_PERIOD_ACTIVE)->paginate();    
