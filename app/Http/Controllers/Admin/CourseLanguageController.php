...
class CourseLanguageController extends Controller
{
    ...
    public function store(CourseLanguageRequest $request)
    {
        ...
        $this->model->create($request->only($this->model->getModel()->fillable));
           ...
           $model = 'Course_language'; // ou qualquer valor que você tenha

        // Substituir 'Category' por 'categoria'
        $modelForMessage = str_replace('Course_language', 'Idioma', $model);

        // Agora, você pode usar $modelForMessage onde precisar
        return $this->controlRedirection($request, 'course-language', $modelForMessage);
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('error', __('Idioma deletado com sucesso'));
