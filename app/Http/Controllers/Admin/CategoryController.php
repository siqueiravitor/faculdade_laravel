...
class CategoryController extends Controller
{
    ...
    public function store(CategoryRequest $request)
    {
        ...
        $this->model->create($data); // create new category
         ...
         $model = 'Category'; // ou qualquer valor que você tenha

        // Substituir 'Category' por 'categoria'
        $modelForMessage = str_replace('Category', 'Categoria', $model);

        // Agora, você pode usar $modelForMessage onde precisar
        return $this->controlRedirection($request, 'category', $modelForMessage);
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('error', __('Categoria deletada com secesso'));
