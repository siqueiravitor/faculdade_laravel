...
class PromotionController extends Controller
{
    ...
    public function store(PromotionRequest $request)
    {
        ...
        $this->showToastrMessage('success', __('Promoção criada com sucesso'));
    ...
    public function update(PromotionRequest $request, $uuid)
    {
        ...
        $this->showToastrMessage('success', __('Promoção atualizada com sucesso'));
        return redirect()->route('promotion.index');
    }
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('success', __('Promoção deletada com sucesso'));
    ...
    public function addPromotionCourseList(Request $request)
    {
        ...
        if ($anotherPromotionCourseList){
            return response()->json([
                'status' => '409',
                'msg' => 'Já adicionado em outra lista de promoção!'
            ]);
        } else {
            ...
            return response()->json([
                'status' => '200',
                'msg' => 'Curso adicionado na lista de promoção.',
    ...
    public function removePromotionCourseList(Request $request)
    {
        ...
        if ($promotionCourse){
            ...
            return response()->json([
                'status' => '200',
                'msg' => 'Curso removido da lista de promoção.',
                'course_id' => $request->course_id
            ]);
        }
