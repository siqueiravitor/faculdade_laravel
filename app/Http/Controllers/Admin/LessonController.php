...
use App\Http\Requests\Admin\LessionRequest;
...
class LessonController extends Controller
{
    ...
    public function uploadLecture($course_uuid, $lesson_uuid)
    {
        ...
        return view('admin.course.upload-lecture', $data);
    }
...
//            $lecture->audio = $request->audio ? $this->uploadFile('lecture', $request->audio) :   null;
    ...
    public function editLecture($course_uuid, $lesson_uuid, $lecture_uuid)
    {
        ...
        return view('admin.course.edit-lecture', $data);
    }
...
//            $lecture->audio = $request->audio ? $this->uploadFile('lecture', $request->audio) :   null;
        ...
        return redirect(route('admin.course.edit', [$lecture->course->uuid, 'step=lesson']));
    }
    ...
    public function deleteLecture($course_uuid, $lecture_uuid)
    {
        ...
        return redirect(route('admin.course.edit', [$course_uuid, 'step=lesson']));
    }
