...
class SubcategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Gerenciar Subcategoria';
    ...
    public function store(SubcategoryRequest $request)
    {
        ...
        $model = 'Subcategory'; // ou qualquer valor que você tenha

        // Substituir 'Category' por 'categoria'
        $modelForMessage = str_replace('Subcategory', 'Subcategoria', $model);

        // Agora, você pode usar $modelForMessage onde precisar
        return $this->controlRedirection($request, 'subcategory', $modelForMessage);
    }
